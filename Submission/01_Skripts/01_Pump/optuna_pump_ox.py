...
from pump_design_ox import *


def objective(trial):
    n = trial.suggest_int('n', 35_000, 39_001)
    psi = trial.suggest_float('psi', 0.68, 0.701)
    phi = trial.suggest_float('phi', 0.14, 0.16)
    R = trial.suggest_float('R', 0.66, 0.678)
    delta_h = 0.25
